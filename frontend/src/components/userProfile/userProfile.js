...
class UserProfile extends Component {
  ...
  componentWillUpdate = async (prevProps, prevState) => {
    if (
      (this.state.invalidEmail === true && prevState.invalidEmail === false) ||
      (this.state.invalidMobile === true &&
        prevState.invalidMobile === false) ||
  ...
  render() {
    ...
    if (this.state.datasubmitted && this.state.timeout) {
      submitted_status = (
        <div
          ...
          id="successDisp"
          style={{ margin: "60px 30% 0 30%", textAlign: "center" }}
          role="alert"
        >
    ...
    let img_src =
      "https://spitwise.s3-us-west-2.amazonaws.com/" +
      (this.state.imageUrl
        ? this.state.imageUrl
                  ...
                  <select
                    ...
                    value={
                      this.state.currency
                        ? this.state.currency
                        : this.state.userProfile
                        ? this.state.userProfile.currency
                        : "USD"
                    }
                  >
                  ...
                  <select
                    ...
                    value={
                      this.state.timezone
                        ? this.state.timezone
                        : this.state.userProfile
                        ? this.state.userProfile.time_zone
                        : "-8"
                    }
                    style={{ width: "80%" }}
                  >

        ...
        if(localStorage.getItem('userProfile')){
            ...
            navLogin = (
                <div style={{width:'100%'}}>
                    <Link to='/'><img id="logo" width="110px" alt="logo" style={{float:'left', margin:'7px 0'}} src="https://assets.splitwise.com/assets/core/logo-wordmark-horizontal-white-short-c309b91b96261a8a993563bdadcf22a89f00ebb260f4f04fd814c2249a6e05d4.svg"></img></Link>
                    <ul className="nav navbar-nav navbar-right" style={{flexDirection:'row', float:'right'}}>
                        {/* <button className="btn btn-primary link-green" style={{paddingTop:'0px', paddingBottom:'0px', maxHeight:'35px'}}><Link to="/login" style={{color:'#fff', textDecoration:'none', fontWeight:'bold'}}>Log in</Link></button> */}
                        ...
                        {/* <button className="btn btn-primary link-orange" style={{paddingTop:'0px', paddingBottom:'0px', maxHeight:'35px'}}><Link to="/signup" style={{color:'#fff', textDecoration:'none', fontWeight:'bold'}}>Sign up</Link></button> */}

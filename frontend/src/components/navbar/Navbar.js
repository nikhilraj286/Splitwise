...
class Navbar extends Component {
    ...
    render(){
            ...
            navLogin = (
                <div style={{width:'100%'}}>
                    ...
                    <ul class="nav navbar-nav navbar-right"  style={{flexDirection:'row', float:'right'}}>
                        ...
                        <button onClick = {this.handleLogout} className="btn btn-primary btn-orange" style={{paddingTop:'0px', paddingBottom:'0px', height:'35px'}}><Link to="/" style={{color:'#fff', textDecoration:'none', fontWeight:'bold'}}>Log out</Link></button>
                    </ul>
                </div>
            );
        }else{
        ...
        return(
            <div>
                {redirectVar}
            <nav class="navbar navbar-inverse" style={{backgroundColor:'#5BC5A7', boxShadow:'0px 1px 5px 2px #bbb'}}>
                <div class="container-fluid" style={{paddingLeft:'200px', paddingRight:'200px'}}>
